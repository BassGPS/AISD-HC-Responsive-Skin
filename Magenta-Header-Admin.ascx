...
<link rel="stylesheet" type="text/css" href="/AISD/Portals/_default/Skins/HC Responsive/magentaskin.css">
		...
		<div class="fullWidth">
			...
			<div class="contentWidth">
				<div class="maincontentDiv">	
					<div id="contentPane" class="contentPane" runat="server" style="display: block; max-width: 100%;"></div>
				</div>
