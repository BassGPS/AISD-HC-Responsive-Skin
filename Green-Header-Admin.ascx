...
<link rel="stylesheet" type="text/css" href="/AISD/Portals/_default/Skins/HC Responsive/greenskin.css">
		...
		<div class="fullWidth">
			...
			<div class="breadcrumbsearchWrapper">
				...
				<div class="dateDiv"><dnn:CURRENTDATE runat="server" id="dnnCURRENTDATE" cssclass="Date" />
                				...
                				<div class="search"><dnn:SEARCH runat="server" id="dnnSEARCH" Submit="<img src=&quot;images/BlueSearch.jpg&quot; align=&quot;top&quot; border=&quot;0&quot;>" />
				</div>
				</div>
			<div class="contentWidth">
				<div class="maincontentDiv">	
					<div id="contentPane" class="contentPane" runat="server" style="display: block; width: 100%;"></div>
				</div>
