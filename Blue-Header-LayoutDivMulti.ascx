...
<link rel="stylesheet" type="text/css" href="/AISD/Portals/_default/Skins/HC Responsive/blueskin.css">
...
<div class="twocolumnPane">
				...
				<div id="siteFooter">
					...
					</div>														<div class="CopyPrivacyTerms"><dnn:COPYRIGHT runat="server" id="dnnCOPYRIGHT" cssclass="Footer" />&nbsp;&nbsp;|&nbsp;&nbsp;<dnn:PRIVACY runat="server" id="dnnPRIVACY" cssclass="Footer" />&nbsp;&nbsp;|&nbsp;&nbsp;<dnn:TERMS runat="server" id="dnnTERMS" cssclass="Footer" />&nbsp;&nbsp;|&nbsp;&nbsp;<dnn:USER runat="server" id="dnnUSER" cssclass="User" />&nbsp;&nbsp;<dnn:LOGIN runat="server" id="dnnLOGIN" cssclass="Login" /></div>
					</div>
				</div>
			</div>
			<div class="rightWidth"></div>
